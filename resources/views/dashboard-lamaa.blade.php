        ...
        <div class="card" style="margin-top: 70px;">
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            <p class="mb-0 font-weight-bold" style="font-size:25px;">Kecamatan</p>
                            <h5 class="font-weight-bolder">
                                {{ $total }}
                            </h5>
                        </div>
                        <div class="text-end">
                        <div class="icon icon-shape bg-gradient-primary shadow-primary text-center rounded-circle">
                            <span class="ni ni-money-coins text-lg opacity-10" aria-hidden="true"></span>
                        </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-body p-3">
                <div class="row">
                    <div class="col-8">
                        <div class="numbers">
                            <p class="mb-0 font-weight-bold" style="font-size:25px;">Jenis Kesenian</p>
                            <h5 class="font-weight-bolder">
                                {{ $totaljk }}
                            </h5>
                        </div>
